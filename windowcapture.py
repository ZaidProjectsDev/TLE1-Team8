...
class WindowCapture:
    ...
    def __init__(self, window_name=None):
        ...
        if not self.hwnd:
            self.doesnt_have_window = True
    def has_window(self):
        if self.hwnd is None:
            self.doesnt_have_window = True
            return False
        else:
            self.doesnt_have_window = False
            return True
        
    def set_new_window_sizing(self):
        if self.has_window():
    ...
    def set_game_window(self, window):
        self.hwnd= win32gui.GetWindow(window)
        self.set_new_window_sizing()
